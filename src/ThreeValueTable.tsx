  ...
  return (
    <div style={{ maxWidth: 500, margin: '0 auto', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ marginTop: 10, textAlign: 'center' }}>
        ...
        <p style={{fontSize:'12px'}}>In Progress:<span style={{backgroundColor:'#DC3545',fontWeight:600,color:'white', padding:'5px', borderRadius:'50%'}}> {inProgress.toLocaleString()}</span></p>
      </div>
    </div>
  );
};
